...
export type BasketballLiveEventType =
  | 'FT_MADE' | 'FT_MISS'
  | 'FG2_MADE' | 'FG2_MISS'
  | 'FG3_MADE' | 'FG3_MISS'
...
const ROWS: Array<Array<{ type: BasketballLiveEventType; label: string }>> = [
...
export interface BasketballLiveEventPadProps {
  disabled?: boolean
  onEvent: (type: BasketballLiveEventType) => void
  className?: string
}
...
export function BasketballLiveEventPad({ disabled, onEvent, className }: BasketballLiveEventPadProps) {
  return (
